        ...
        <div class="site-menus" :class="{'mobileShow':mobileShow}" @click.stop="mobileShow=!mobileShow">
            ...
            <div class="menu-item hasChild">
                ...
                <div class="childMenu" v-if="category.length">
                    <div class="sub-menu" v-for="item in category" :key="item.cateName"><router-link :to="`/category/${item.cateName}`">{{item.cateName}}</router-link></div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchCategory() {
              getRequest("/api/usr/category/all").then(resp=> {
