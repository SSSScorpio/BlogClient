    ...
    <div id="layout-footer">
        <div class="footer-main">
            ...
            <div class="footer-item">
                ...
                <div><el-link type="primary" @click.native.prevent="checkClick">后台入口</el-link></div>

                <div><el-link type="primary" @click.native.prevent="logoutClick">退出登录</el-link></div>
            </div>
        </div>
    ...
    export default {
        ...
        methods:{
          ...
          checkClick: function () {
            var _this = this;
            this.loading = true;
            const url = "/api/usr/forecheckLogin"
