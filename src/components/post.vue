<template>
    <article class="post post-list">
        <div class="post-entry">
            ...
            <div class="p-time">
                <i class="iconfont iconmeditor-time"></i> {{post.editTime | parseTime}}<i v-if="post.isHot" class="iconfont iconfire" style="margin-left: 5px;color: #ff6d6d;"></i>
            </div>
                ...
                <div class="info-meta">
                    <div class="comnum">
                        <span>
                            ...
                            <a href="https://zhebk.cn/Web/Akina.html">{{post.pageView}} 条评论</a>
                        </span>
                    </div>
                    <div class="views">
                        <span><i class="iconfont iconeyes"></i>{{post.pageView}} 热度</span>
                    </div>
                </div>
            </footer>
        </div>
